...
<%
	...
	{
		%>
		<center><font color="red" size="5">Invalid usaername/password</font></center>
	<%
	}
	%>
...
<form action="adminLoginAction.jsp" mathod="post">
<div class="form-group">
<center><h2>Username</h2></center>
<input type="text" placeholder="Enter username" name="username" required>
<center><h2>Password</h2></center>
<input type="password" placeholder="Enter pasword" name="password" required>
